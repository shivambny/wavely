...
export class Backend implements backendInterface {
    ...
    async addRecentlyPlayed(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRecentlyPlayed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPlaylist(arg0: string): Promise<Playlist> {
        if (this.processError) {
            try {
    ...
    async deletePlaylist(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getLikedTracks(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLikedTracks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOfflineTracks(): Promise<Array<OfflineTrack>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOfflineTracks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlaylist(arg0: string): Promise<Playlist> {
        if (this.processError) {
            try {
    ...
    async getRecentlyPlayed(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async removeOfflineTrack(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeOfflineTrack(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveOfflineTrack(arg0: OfflineTrack): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveOfflineTrack(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
